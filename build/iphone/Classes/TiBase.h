...
// in simulator we redefine to format for IndiaMap Developer console
...
{\
	NSString * exceptionName = [@"org.indiamap." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.indiamap";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIIndiaMapNativeItemNone = -1, 
	UIIndiaMapNativeItemSpinner = -2,
	UIIndiaMapNativeItemProgressBar = -3,
	
	UIIndiaMapNativeItemSlider = -4,
	UIIndiaMapNativeItemSwitch = -5,
	UIIndiaMapNativeItemMultiButton = -6,
	UIIndiaMapNativeItemSegmented = -7,
	
	UIIndiaMapNativeItemTextView = -8,
	UIIndiaMapNativeItemTextField = -9,
	UIIndiaMapNativeItemSearchBar = -10,
	
	UIIndiaMapNativeItemPicker = -11,
	UIIndiaMapNativeItemDatePicker = -12,
	
	UIIndiaMapNativeItemInfoLight = -13,
	UIIndiaMapNativeItemInfoDark = -14,
	
	UIIndiaMapNativeItemDisclosure = -15,
	
	UIIndiaMapNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all IndiaMap instances of
