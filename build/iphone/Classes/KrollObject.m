...
//@interface IndiaMapObject : NSObject
//@end

@interface IndiaMapObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[IndiaMapObject class]])
		{
			for (NSString *key in [[(IndiaMapObject*)o modules] allKeys])
			{
