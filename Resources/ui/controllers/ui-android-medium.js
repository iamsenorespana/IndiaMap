(function(){
	...
	App.ui.android.medium = {

	};

		App.ui.android.medium.createMainWindow = function(){
			...
			var win = Ti.UI.createWindow({
				...
				backgroundImage: '/images/android-' + App.ui.density + '-background-wood.png'
					...
					App.ui.android.topBar = App.ui.android.medium.createTopBar();
					...
					App.ui.android.bottomBar = App.ui.android.medium.createBottomBar();
			...
			Ti.App.addEventListener('app:showAlert', function(e){
				App.ui.android.medium.viewLogin = require('views/android-alert').load();			
				win.add( App.ui.android.medium.viewLogin.view );
			...
			Ti.App.addEventListener('app:hideAlert', function(e){
				...
				win.remove( App.ui.android.medium.viewLogin.view );
 	...
 	App.ui.android.medium.createTopBar = function(){
 	...
 	App.ui.android.medium.createBottomBar = function(){
			...
			var _view = Ti.UI.createView({
				...
				App.ui.android.btn1 = Ti.UI.createButton({
					...
					App.ui.android.btn1.addEventListener('touchend', function(e){
						...
						// Switch screens
					//	App.ui.android.medium.view5.hide();	
					//	App.ui.android.medium.view4.hide();
					//	App.ui.android.medium.view2.hide();
					//	App.ui.android.medium.view3.hide();
					//	App.ui.android.medium.view1.show();
				...
				App.ui.android.btn2 = Ti.UI.createButton({
					...
					App.ui.android.btn2.addEventListener('touchend', function(e){
						...
						//	App.ui.android.medium.view5.hide();	
						//	App.ui.android.medium.view4.hide();
						//	App.ui.android.medium.view1.hide();
						//	App.ui.android.medium.view3.hide();
						//	App.ui.android.medium.view2.show();
				...
				App.ui.android.btn3 = Ti.UI.createButton({
					...
					App.ui.android.btn3.addEventListener('touchend', function(e){
						...
						//	App.ui.android.medium.view2.hide();
						//	App.ui.android.medium.view1.hide();
						//	App.ui.android.medium.view3.show();
				...
				App.ui.android.btn4 = Ti.UI.createButton({
					...
					App.ui.android.btn4.addEventListener('touchend', function(e){
						...
						//	App.ui.android.medium.view2.hide();
						//	App.ui.android.medium.view3.hide();
						//	App.ui.android.medium.view4.show();
